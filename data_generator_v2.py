...
# List of companies
company_names = [
    "NexaTech Manufacturing",
    "QuantumForge Industries",
    "TerraVista Fabrication",
    "SkyHigh Engineering",
    "UrbanEdge Machinery",
    "StellarWave Manufacturing",
    "ApexFusion Works",
    "BlueHorizon Steel",
    "OptiCore Fabrication",
    "BrightMinds Machining",
    "GreenWave Manufacturing",
    "ZenithWorks Industries",
    "SwiftStream Foundry",
    "NovaSphere Fabrication",
    "InfiniteCrest Engineering",
    "PrismPeak Manufacturing",
    "UltraNet Foundry",
    "EcoVista Steelworks",
    "OmniTech Fabrication",
    "CrystalClear Machining",
    "AeroNext Engineering",
    "VitalEdge Manufacturing",
    "QuantumEcho Foundry",
    "PureWave Fabrication",
    "SummitRise Steelworks",
    "RapidFlow Machining",
    "PeakPerformance Engineering",
    "SolarFlare Fabrication",
    "HorizonX Foundry",
    "Ascendia Steelworks",
    "Martin-Holden",
    "Ward-Hays",
    "CarterGroup",
    "Allen,WilliamsandWhite",
    "Chandler,TurnerandHouston",
    "Perry-Garcia",
    "Wells-Randall",
    "Martinez-Wilson",
    "Simmons-Turner",
    "Mcdaniel,MooreandJackson",
    "Bennett,VillegasandFowler",
    "MortonandSons",
    "Walker,CruzandGarcia",
    "Stone,WestandBurns",
    "Klein,RobinsonandMiller",
    "HintonLLC",
    "Waters,ReynoldsandHoward",
    "ShortLtd",
    "LeachGroup",
    "Harris,CrawfordandScott",
    "Williams,GouldandLewis",
    "GarciaGroup",
    "Ward-Wilcox",
    "HintonGroup",
    "ElliottLtd",
    "Henderson,BoydandShelton",
    "Bass-Bolton",
    "Santiago,HarrisandLynch",
    "SmithLtd",
    "Nolan,MeyersandJohnson",
]
...
def generate_shipment(shipment_number):
    ...
    date2 = fake.date_between(
        date.fromisoformat("2023-01-01"), date.fromisoformat("2024-07-25")
    )
    origin = random.choice(locations)
    destination = (
        "Barcelona"
        if origin != "Barcelona"
        else random.choice([loc for loc in locations if loc != "Barcelona"])
    )
